...
// 2) Preload — CJS (o preload em sandbox tem de ser CommonJS). package.json local fixa o tipo.
await build({
...
console.log(
  "✓ build do desktop pronto em dist-build/ (main ESM · preload CJS · renderer IIFE+CSS)",
);
